    ...
    <div id="appAdmin">
      ...
      <b-container @click="showSidebar = false">
            ...
            <form @submit.prevent="createUser()" action="#">
              ...
              >
                ...
                <b-collapse visible id="collapse-1" class="mt-2">
                    ...
                    <div class="row">
                      ...
                      <div>
                        <b-jumbotron>
                          ...
                          <template #lead>
                            ${text1} <span v-b-modal.modal-1 class="btn btn-sm btn-info">${keyword[0].label}</span> ${text2} <span v-b-modal.modal-2 class="btn btn-sm btn-info">${keyword[1].label}</span> ${text3}
                          </template>
                      
                          <hr class="my-4">
                      
                          <p>
                            Este es un fragmento de la autora Keiko Kasza es su libro una cena elegante.
                          </p>
                        </b-jumbotron>
                      </div>
                  ...
                  <button class="btn btn-primary" type="submit">Mostrar mas contenido</button>
        ...
        <b-modal id="modal-1" title="Madriguera" hide-footer>
          ...
          <b-button size="sm" variant="primary" block @click="validaResp">Guardar</b-button>
        </b-modal>
      ...
      <script>
        let appAdmin = new Vue({
          ...
          data: {
            ...
            text3: "a buscar su cena elegante. ",
            keyword: [{label: 'madriguera'}, {label: 'ávido'}],
          ...
          methods:{
            validaResp(){
              this.selectedx == 'A' 
                ? this.showAlert('Felicidades... has sumado 100 puntos', 'success')
